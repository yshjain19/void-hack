...
async def build_pdf_report(
    ...
    story.append(Paragraph("🔍 ForensIQ", title_style))
    ...
    story.append(Paragraph(
        "This report was generated by ForensIQ, an AI-assisted forensic investigation platform. "
        ...
        "ForensIQ does not warrant the completeness or accuracy of AI-generated assessments.",
        body_style,
    ))
